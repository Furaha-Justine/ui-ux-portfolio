      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex justify-center lg:justify-end animate-fade-in-up">
            <div className="relative w-80 h-80 rounded-3xl overflow-hidden shadow-elegant hover:shadow-elegant-hover transition-all-smooth animate-float">
          ...
          <div className="text-center lg:text-left space-y-6">
            <div className="flex items-center justify-center lg:justify-start gap-2 mb-4">
              ...
              <h1 className="text-4xl md:text-6xl font-bold gradient-text text-balance">Uwizeyimana Furaha Justine</h1>
              <Sparkles className="w-6 h-6 text-secondary animate-pulse-subtle" style={{ animationDelay: "0.5s" }} />
            </div>
            ...
            >
              Crafting intuitive digital experiences that bridge the gap between user needs and business goals through
            ...
            >
              <CTAButton variant="primary" size="lg" onClick={scrollToWork} className="w-full sm:w-auto">
                View My Work
              </CTAButton>
              <CTAButton variant="secondary" size="lg" onClick={scrollToContact} className="w-full sm:w-auto">
                Schedule a Meeting
              </CTAButton>
            </div>
          </div>
